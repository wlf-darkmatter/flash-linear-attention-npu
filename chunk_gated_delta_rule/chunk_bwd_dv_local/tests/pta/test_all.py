...
from utils import generate_cu_seqlens, create_tensor, bool_matrix_to_uint8

def test_variable():
    B=64,H=8,T=1024,K=128,V=128,cu_seqlens_len=None,chunk_num=None,scale=0.088,chunk_size=64
    print(B)
    print(H)
    ...
    #     cu_seqlens_npu = cu_seqlens.n.npu()
